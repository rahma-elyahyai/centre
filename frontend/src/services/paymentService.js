...
export const paymentAPI = {
  getAll: () => api.get('/api/payments').then(r => r.data),
  getAllPayments: async (params = {}) => {
    ...
    const response = await api.get('/api/payments', { params: queryParams });
  ...
  markAsPaid: async (id, paymentMethod) => {
    const response = await api.patch(`/api/payments/${id}/mark-paid`, null, {
